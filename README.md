...
## 2794 steps (44704 images)

```shell
python kitti_eval/eval_depth.py --kitti_dir=/home/ubuntu/data/raw_data_KITTI/ --pred_file=/home/ubuntu/data/result_20200518_2794/result.npy
```

abs_rel,     sq_rel,        rms,    log_rms,     d1_all,         a1,         a2,         a3,     scalor 

0.2104,     1.7102,     7.5172,     0.3000,     0.0000,     0.6551,     0.8670,     0.9474 ,   30.4606 

## 5588 steps ( images)

```shell
python kitti_eval/eval_depth.py --kitti_dir=/home/ubuntu/data/raw_data_KITTI/ --pred_file=/home/ubuntu/data/result_20200518_5588/result.npy
```

abs_rel,     sq_rel,        rms,    log_rms,     d1_all,         a1,         a2,         a3,     scalor 

0.1845,     1.3673,     6.1840,     0.2577,     0.0000,     0.7277,     0.9045,     0.9664 ,   27.7343


## 8382 steps ( images)

```shell
python kitti_eval/eval_depth.py --kitti_dir=/home/ubuntu/data/raw_data_KITTI/ --pred_file=/home/ubuntu/data/result_20200518_8382/result.npy
```

abs_rel,     sq_rel,        rms,    log_rms,     d1_all,         a1,         a2,         a3,     scalor 

0.1754,     1.2882,     6.1200,     0.2506,     0.0000,     0.7450,     0.9105,     0.9679 ,   25.6808 

## 11176 steps ( images)

```shell
python kitti_eval/eval_depth.py --kitti_dir=/home/ubuntu/data/raw_data_KITTI/ --pred_file=/home/ubuntu/data/result_20200518_11176/result.npy
```

abs_rel,     sq_rel,        rms,    log_rms,     d1_all,         a1,         a2,         a3,     scalor 

0.1721,     1.2687,     6.0087,     0.2459,     0.0000,     0.7548,     0.9153,     0.9688 ,   23.2049 
...
0.1695,     1.2474,     6.2880,     0.2513,     0.0000,     0.7484,     0.9111,     0.9667 ,   21.3934 
